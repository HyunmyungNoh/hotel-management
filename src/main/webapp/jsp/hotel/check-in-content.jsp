...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/hotel/check-in-content.js' />"></script>
    </jsp:attribute>
...
<!--                                 </div>
        ...
        <div class="button-warp"  style="text-align: center; padding-top: 10px;">
            <button type="button" class="btn btn-fn1" data-page-btn="checkin">체크인</button>
