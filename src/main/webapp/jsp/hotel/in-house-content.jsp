...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/hotel/in-house-content.js' />"></script>
    </jsp:attribute>
...
<!--                                 </div>
                                <div class="form-group"> -->
                                    <input type="hidden" data-ax-path="roomId" class="form-control js-roomId" />
                                    <input type="text" data-ax-path="roomNum" class="form-control js-roomNum" />
                                    <button type="button" class="btn btn-default" data-grid-view-01-btn="allocate"><i class="cqc-magnifier"></i> 객실배정</button>
                                <!-- </div> -->
                            </div>   
                        </div>
                        <div class="right">
        ...
        <div class="button-warp"  style="text-align: center; padding-top: 10px;">
            <button type="button" class="btn btn-fn1" data-page-btn="checkOut">체크아웃</button>
            <button type="button" class="btn btn-fn1" data-page-btn="checkCancel">체크인 취소</button>
